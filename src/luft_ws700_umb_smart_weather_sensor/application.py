...
from .app_state import LuftWs700UmbSmartWeatherSensorState
...
class LuftWs700UmbSmartWeatherSensorApplication(Application):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.state: LuftWs700UmbSmartWeatherSensorState = None

    async def setup(self):
        self.ui = LuftWs700UmbSmartWeatherSensorUI()
        self.state = LuftWs700UmbSmartWeatherSensorState()
